...
var instrucciones = ['mover las piezas con las flechas', 'armar la figura', 'si la armas ganas'];
...
function UltimoMovimiento(direccion) {
  //if (direccion === codigosDireccion.IZQUIERDA || direccion === codigosDireccion.ARRIBA || direccion === codigosDireccion.ABAJO || direccion === codigosDireccion.Direccion.DERECHA) {
...
//       var piezasPikachu = grilla[i][j];
//       //debugger;
//       if (grillaOrdenada[i][j] === piezasPikachu) {
//         return true;
//       } else {
//         return false;
//       }
...
function intercambiarPosicionesGrilla(filaPos1, columnaPos1, filaPos2, columnaPos2) {
  var nuevaPos = grilla[filaPos1][columnaPos1];
  grilla[filaPos1][columnaPos1] = grilla[filaPos2][columnaPos2];
  grilla[filaPos2][columnaPos2] = nuevaPos;
}
